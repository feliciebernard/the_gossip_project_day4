...
ActiveRecord::Schema.define(version: 2021_05_13_082129) do
  ...
  create_table "tag_and_gossips", force: :cascade do |t|
    t.bigint "gossip_id"
    t.bigint "tag_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gossip_id"], name: "index_tag_and_gossips_on_gossip_id"
    t.index ["tag_id"], name: "index_tag_and_gossips_on_tag_id"
  end
